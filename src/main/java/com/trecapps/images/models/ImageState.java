...
public enum ImageState {
    ...
    PRE_PUBLIC(false), // similar to UPLOADED, but make public once analysis is done (if not adult)
    PRE_PROFILE(false), // siilar to PRE_PUBLIC, but make the image the profile of the uploader
